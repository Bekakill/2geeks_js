...
function capitalizeString(tor) {if (!tor) return;
    return tor.charAt(0).toUpperCase() + tor.slice(1).toLowerCase();}
console.log(capitalizeString("БЕКНАЗАР"));
console.log(capitalizeString("тИЛАбЕКОВ"));
console.log(capitalizeString("зАттаРбекоВич"));

function evenOddSum(lord) {
    let evenSum = 0;
    let oddSum = 0;
    for (const num of lord) {
...
console.log(evenOddSum([1, 2, 3, 4, 5]));
console.log(evenOddSum([10, 21, 32, 43, 54]));
console.log(evenOddSum([1000, 1500, 2500, 3501]));
console.log(evenOddSum([1, 2, 3, 4, 5, 100, 101, 200]));
console.log(evenOddSum([2, 4, 6, 8]));
